...
title: Client
tags: [oauth 2.0, oidc]
description: In OAuth 2.0 and OpenID Connect (OIDC), a client is an application that requests authentication or authorization on behalf of a user or itself. Clients can be public or private, and they use different grant types to obtain tokens.
---
...
Private clients are applications that can confidentially store sensitive information without exposing it to resource owners (end-users). Examples of private clients include:
