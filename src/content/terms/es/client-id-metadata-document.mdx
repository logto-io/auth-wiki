...
sequenceDiagram
    ...
    Client->>AS: Solicitud de autorización con<br/>`client_id=https://client.example.com/metadata`
    AS->>Client: Obtiene metadatos desde la URL de client_id
    Client-->>AS: Devuelve documento JSON de metadatos
    AS->>User: Muestra pantalla de consentimiento<br/>con información del client desde los metadatos
    User->>AS: Otorga autorización
