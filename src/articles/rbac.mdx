...
tags: [authorization]
description: Role-based access control (RBAC) is a widely adopted access control model that introduces the concept of "roles" to decouple users from permissions.
---
